...
<body>
    <form id="form1" runat="server">
        <div>
           <center> <h1 style="color: #1E90FF;"> Advance Programming Summer Semester Project</h1> </center>
             <center> <h1 style="color: #1E90FF;"> Employees Data Record </h1> </center>
              <center> <h2 style="color: #0000FF;"> Admin Control </h2> </center>



        <center>   <asp:GridView ID="gvPhoneBook" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="PhoneBookID"
            ...
            <br />
          <center>  <asp:Label ID="lblSuccessMessage" Text="" runat="server" ForeColor="Green" /> 
            <br />
             <asp:Label ID="lblErrorMessage" Text="" runat="server" ForeColor="Red" /> </center>
